...
print('=========', 'Correlation_analysis for','=========')
root = '/media/acxyle/Data/ChromeDownload/Identity_VGG_Results/'
idx_root = '/media/acxyle/Data/ChromeDownload/Identity_VGG_Neuron/'
dest = '/media/acxyle/Data/ChromeDownload/Identity_VGG_Neuron/Distance/'
if not os.path.exists(dest):
    os.makedirs(dest)

layer_list = [
    'ReLU_2_2','ReLU_3_3', 'conv_4_3', 'ReLU_4_3','conv_5_3', 'ReLU_5_3', 'fc_6','ReLU_6', 'fc_7', 'ReLU_7', 'fc_8'
]


for idx, layer in enumerate(layer_list): # each layer

    with open(root + layer + '.pkl', 'rb') as f:
