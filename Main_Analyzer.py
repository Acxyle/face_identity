...
def imaginary_neurons(layers, neurons, shapes):
    layers_ = [i for i in layers if 'neuron_1' in i or 'neuron_2' in i or 'dropout' in i or 'fc' in i]
...
def Main_Analyzer(args):
    ...
    #layers, neurons, shapes = imaginary_neurons(layers, neurons, shapes)
