...
def color_column(layers):
    ...
    print(layers_t)
    color = ['teal', 'orange', 'lightskyblue', 'tomato', 'red']
    layers_c_dict = {}
...
# plot
root = '/media/acxyle/Data/ChromeDownload/Identity_VGG_Neuron/'

alpha = 0.01
layers = [     'conv_1_1','bn_1_1', 'ReLU_1_1', 'conv_1_2', 'bn_1_2', 'ReLU_1_2',
